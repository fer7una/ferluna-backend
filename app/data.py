...
CV = {
    "summary": (
        "Perfil técnico orientado a crear herramientas web, automatizaciones y documentación "
        "que ayudan a equipos y usuarios a trabajar con menos fricción."
    ),
    "experience": [
        {
            ...
            "description": "Diseño y desarrollo de interfaces, APIs y sistemas de documentación para proyectos propios y clientes.",
        },
        {
            "period": "2022 - 2024",
            "title": "Desarrollador full-stack",
            "company": "Proyectos independientes",
            "description": "Integración de frontend, backend y automatizaciones para portales, paneles internos y webs de contenido.",
        },
    ],
    "skills": [
        "React",
    ...
    "education": [
        {
            ...
            "detail": "Frontend moderno, backend Python, documentación técnica y herramientas de IA aplicadas al desarrollo.",
        }
    ],
}
...
POSTS = [
    {
        ...
        "date": "2026-05-19",
        "excerpt": "Notas sobre arquitectura separada, diseño orbital e integración progresiva de contenido real.",
        "href": "#",
    },
    {
